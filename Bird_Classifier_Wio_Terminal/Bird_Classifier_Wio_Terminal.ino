...
#ifndef PRODUCT_UID
#define PRODUCT_UID "com.gmail.d.prasannaakumar:my_wifi_module" // "com.my-company.my-name:my-project"
...
void lcd_print_string(const char str[]) 
{
  ...
  else if(strcmp(str,"Savannanightjar") == 0) 
  {
//    int frequency = 4000;
...
//    }
   ...
   J *req = notecard.newRequest("note.add");
        if (req != NULL)
        {
          ...
          if (body != NULL)
          {
            JAddStringToObject(body, "Bird Detected", "Savanna Night Jar");
          }
...
void init1() {
  ...
  if (myProductID[0])
  {
    JAddStringToObject(req, "ssid", "Vyoman");
    JAddStringToObject(req, "password", "Vyoman@CleanAirIndia");
  }
  notecard.sendRequestWithRetry(req, 10); // 5 seconds
}
